...
export default function EditMotorcycleModal({ isOpen, onClose, motorcycle, onSave }) {
  const [formData, setFormData] = React.useState(motorcycle || {});
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
      <div className="bg-white rounded-lg shadow-lg p-6 w-[500px]">
        <h2 className="text-xl font-semibold mb-4">Editar Moto</h2>
