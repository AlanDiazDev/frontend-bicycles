...
export default function EditParkingModal({ isOpen, onClose, parking, onSave }) {
    const [formData, setFormData] = React.useState(parking || {});
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <div className="bg-white rounded-lg shadow-lg p-6 w-[600px]">
                <h2 className="text-xl font-semibold mb-4">Editar Estacionamiento</h2>
